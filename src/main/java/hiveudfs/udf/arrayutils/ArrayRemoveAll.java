...
public class ArrayRemoveAll extends ArrayUtilsBase {
    ...
    public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException {
        ...
        for (int i = 1; i < arguments.length; i++) {
            ...
            if (!ObjectInspectorUtils.compareTypes(elementOI, inputOI)) {
                throw new UDFArgumentTypeException(i,
                    "Argument " + (i + 1) + " of function " + getFuncName() + " must be of the same type as the element of the first argument list" +
