...
abstract class SetBase extends GenericUDF {
    ...
    protected StandardListObjectInspector stdListOI;
    protected StandardMapObjectInspector stdMapOI;
    ...
    public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException {
        ...
        switch (category) {
            case LIST:
                ...
                stdListOI = ObjectInspectorFactory.getStandardListObjectInspector(
                    ObjectInspectorUtils.getStandardObjectInspector(primitive1OI, ObjectInspectorUtils.ObjectInspectorCopyOption.JAVA));
                return stdListOI;
            case MAP:
                ...
                stdMapOI = ObjectInspectorFactory.getStandardMapObjectInspector(
                        ObjectInspectorUtils.getStandardObjectInspector(primitive1OI, ObjectInspectorUtils.ObjectInspectorCopyOption.JAVA),
                        ObjectInspectorUtils.getStandardObjectInspector(map1OI.getMapValueObjectInspector()));
                return stdMapOI;
            default:
