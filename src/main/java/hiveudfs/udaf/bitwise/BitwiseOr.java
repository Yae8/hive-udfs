...
public class BitwiseOr extends AbstractGenericUDAFResolver {
    static final Logger LOG = LoggerFactory.getLogger(BitwiseOr.class.getName());
    ...
    public GenericUDAFEvaluator getEvaluator(TypeInfo[] parameters) throws SemanticException {
        ...
        switch (((PrimitiveTypeInfo) parameters[0]).getPrimitiveCategory()) {
            ...
            case SHORT:
            case INT:
                return new BitwiseOrEvaluator32();
            case LONG:
                return new BitwiseOrEvaluator64();
            default:
    ...
    public static abstract class BitwiseOrEvaluator<ResultType extends Writable> extends GenericUDAFEvaluator {
    ...
    public static class BitwiseOrEvaluator32 extends BitwiseOrEvaluator<IntWritable> {
    ...
    @UDFType(distinctLike = false)
    public static class BitwiseOrEvaluator64 extends BitwiseOrEvaluator<LongWritable> {
