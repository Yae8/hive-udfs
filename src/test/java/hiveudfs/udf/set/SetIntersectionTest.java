...
public class SetIntersectionTest {
    private SetIntersection udf;

    @Before
    public void before() {
        udf = new SetIntersection();
    }
    ...
    public void testEvaluateWithIntType() throws Exception {
        ...
        assertFalse(resultOI.getList(result).contains(1));
        assertFalse(resultOI.getList(result).contains(2));
    ...
    public void testEvaluateWithStringType() throws Exception {
        ...
        assertEquals(1, resultOI.getListLength(result));
        assertFalse(resultOI.getList(result).contains("a"));
        assertFalse(resultOI.getList(result).contains("b"));
    ...
    public void testEvaluateWithIntTypeMap() throws Exception {
        ...
        assertEquals(1, resultOI.getMapSize(result));
        assertFalse(resultOI.getMap(result).containsKey(1));
        assertTrue(resultOI.getMap(result).containsKey(2));
        assertFalse(resultOI.getMap(result).containsKey(3));
    ...
    public void testEvaluateWithStringTypeMap() throws Exception {
        ...
        assertEquals(1, resultOI.getMapSize(result));
        assertFalse(resultOI.getMap(result).containsKey("a"));
        assertTrue(resultOI.getMap(result).containsKey("b"));
        assertFalse(resultOI.getMap(result).containsKey("c"));
